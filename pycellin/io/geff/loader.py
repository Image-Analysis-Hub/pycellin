...
def _set_lin_id_to_nodes(lineages: list[CellLineage]) -> None:
    """
...
def load_GEFF(
    ...
    # FIXME: _split_graph_into_lineages() is already setting a "lineage_ID" property
    # on the lineages
    if lineage_id_prop is None:
        _set_lin_id_to_nodes(lineages)
